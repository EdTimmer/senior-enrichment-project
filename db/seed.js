...
const seed = ()=> {
  Promise.all([
    ...
    Campus.create({name: 'Pelagic Journey Academy', image: 'https://dtmag.com/wp-content/uploads/2004/05/scuba-school-of-fish-1050x700.jpg', description: 'Do you like to swim?  Do you like feeling lost in a crowd?  Wiggle well with others?  Then join our Pelagic Journey Academy!', motto: 'Go (swim) far!'}),
