...
const seed = ()=> {
  Promise.all([
    ...
    Campus.create({name: 'Periscope Down Academy', image: 'https://www.bitsonline.com/wp-content/uploads/2018/02/Kraken1.jpg', description: 'Tired of cruise ships keeps you up all night?  Against submarines sneaking nuclear thingies right through your home?  Join our school and learn how to deal with these problems!', motto: 'Bottoms up!'}),
    Campus.create({name: 'Pelagic Journey Academy', image: 'https://dtmag.com/wp-content/uploads/2004/05/scuba-school-of-fish-1050x700.jpg', description: 'Do you like to swim?  Do you like feeling lost in a crowd?  Do you appreciate synchronized swimming?  Then join our Pelagic Journey Academy!', motto: 'Go (swim) far!'}),
