...
const seed = ()=> {
  Promise.all([
    ...
    Campus.create({name: 'Periscope Down Academy', image: 'https://nerdist.com/wp-content/uploads/2015/09/338400-science-fiction-20000-leagues-under-the-sea-wallpaper.jpg', description: 'Tired of cruise ships keeps you up all night?  Against submarines sneaking nuclear thingies right through your home?  Join our school and learn how to deal with these problems!', motto: 'Bottoms up!'}),
    Campus.create({name: 'Pelagic Journey Academy', image: 'http://twistedsifter.files.wordpress.com/2010/07/large-school-of-fish.jpg', description: 'Do you like to swim?  Do you like feeling lost in a crowd?  Do you appreciate synchronized swimming?  Then join our Pelagic Journey Academy!', motto: 'Go (swim) far!'}),
    Campus.create({name: 'Deep Dive Academy', image: 'https://www.carbonbrief.org/wp-content/uploads/2015/02/stock-deep-ocean-1550x804.jpg', description: 'Do you like the dark?  Cope well under pressure?  Can glow in the dark without swallowing batteries?  Then Deep Dive Academy is for you!', motto: 'How low can you go?'})
